...
public class EditAppointmentPage {
    ...
    public static void setActive(Stage stage) throws IOException {
        ...
        // Main title
        Text title = new Text("Edit Appointment");
        ...
        name.setLayoutX(250);
        name.setLayoutY(100);
        name.setText(EditController.getEditItem().getName());
        ...
        date.setValue(LocalDate.parse(EditController.getEditItem().getDate()));
        date.setLayoutX(250);
        date.setLayoutY(190);
        ...
        timeSlot.getItems().addAll(EditController.loadTimeSlots());
        timeSlot.setValue(EditController.getEditItem().getTimeSlot());
        ...
        course.getItems().addAll(EditController.loadCourses());
        course.setValue(EditController.getEditItem().getCourse());
        ...
        reason.setText(EditController.getEditItem().getReason());
        ...
        comment.setText(EditController.getEditItem().getComment());
        ...
        submitButton.setOnAction(e -> EditController.submit(name, date, timeSlot, course, reason, comment, stage));
